...
6. `po` só dá o veredito final (aprovado / aprovado com ressalvas / reprovado) depois que `qa` confirmar os testes passando e `security` não ter achados críticos em aberto.
